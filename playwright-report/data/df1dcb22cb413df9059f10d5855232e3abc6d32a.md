...
- Name: pages/index.spec.ts >> Payment Section >> can select Brazil package
- Location: tests/e2e/pages/index.spec.ts:163:3

# Error details

```
Error: locator.click: Error: strict mode violation: locator('text=R$ 260,00') resolved to 2 elements:
