...
- Name: pages/index.spec.ts >> Navigation >> Instagram link opens in new tab
- Location: tests/e2e/pages/index.spec.ts:194:3
...
Locator: locator('a[href*="instagram.com"]').first()
Expected: "_blank"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href*="instagram.com"]').first()
