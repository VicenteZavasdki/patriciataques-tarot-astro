...
- Name: pages/index.spec.ts >> Pricing Section >> shows Brazil pricing card
- Location: tests/e2e/pages/index.spec.ts:127:3
...
Locator: locator('text=R$')
Expected: visible
Error: strict mode violation: locator('text=R$') resolved to 2 elements:
