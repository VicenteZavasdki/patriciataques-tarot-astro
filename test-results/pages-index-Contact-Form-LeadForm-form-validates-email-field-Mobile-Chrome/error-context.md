...
- Name: pages/index.spec.ts >> Contact Form (LeadForm) >> form validates email field
- Location: tests/e2e/pages/index.spec.ts:102:3
...
Locator: locator('text=Email inválido')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Email inválido')
