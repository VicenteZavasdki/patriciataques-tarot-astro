...
- Name: pages/index.spec.ts >> Contact Form (LeadForm) >> form validates name field
- Location: tests/e2e/pages/index.spec.ts:95:3
...
Locator: locator('text=Nome deve conter apenas letras')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Nome deve conter apenas letras')
